        ...
        if n == 1:
            ...
            while True:
                ...
                if item.buy_all_previous_item() is False:
                    break
                t_buy_all_item_investments = threading.Thread(target=item.buy_all_item_investments, args=(n,))
                t_buy_all_set_item = threading.Thread(target=item.buy_all_set_item, args=(n,))
                t_buy_all_hero = threading.Thread(target=hero.buy_all_hero, args=(n,))
                t_buy_all_item = threading.Thread(target=item.buy_all_item, args=(n,))
