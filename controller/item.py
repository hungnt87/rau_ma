...
class Item:
    ...
    def get_item_img(self, name):
        ...
        if self.img is None:
            ...
            self.img = self.img = path.get_absolute_path(os.path.join("assets", "img", "item", file_name))
        return self.img
...
Evasion6_For_Precise_lv1 = Item("Evasion6_For_Precise_lv1", number_need_buy = 3)
Evasion8_Speed5_lv1 = Item("Evasion8_Speed5_lv1", number_need_buy = 3)
Evasion12_Strike6_lv2 = Item("Evasion12_Strike6_lv2", number_need_buy = 3)
...
SoulCrystalsPlus35EveryMango_lv2 = Item("SoulCrystalsPlus35EveryMango_lv2", number_need_buy = 1)
...
def buy_all_item(round_number):
    ...
    if 2 < round_number <= 6:
        ...
        t4.join()
        t5.join()
        t6.join()  # buy_all_previous_item()  # buy_all_item_lv3()  # buy_all_item_lv4()  # buy_all_item_lv5()  # buy_all_item_lv6()
