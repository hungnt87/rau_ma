...
def buy_all_item(round_number):
    ...
    if cgv.check_money() is False:
        ...
        return False
    t_buy_all_item_investments = threading.Thread(target = buy_all_item_investments, args = (round_number,))
...
if __name__ == "__main__":
    ...
    start2 = time.time()
    t_buy_all_item_investments = threading.Thread(target = buy_all_item_investments, args = (5,))
